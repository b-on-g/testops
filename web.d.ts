...
declare namespace $ {
     ...
     */
    const $mol_theme: Record<"image" | "line" | "text" | "field" | "current" | "hue" | "back" | "hover" | "card" | "special" | "control" | "shade" | "focus" | "spirit" | "hue_spread", $mol_style_func<"var", unknown>>;
}
...
declare namespace $ {
     ...
     * @see https://mol.hyoo.ru/#!section=demos/demo=mol_textarea_demo
     */
    const $bog_theme: Record<"image" | "line" | "text" | "field" | "current" | "background" | "back" | "hover" | "card" | "special" | "control" | "shade" | "focus" | "spirit", $mol_style_func<"var", unknown>>;
    /**
...
declare namespace $.$$ {
    class $bog_testops_app_generator extends $.$bog_testops_app_generator {
        realm(): typeof $hyoo_crus_glob;
        profile(): $bog_testops_profile | null;
        product(next?: string): string;
        test_type(next?: string): string;
        priority(next?: string): string;
        requirements(next?: string): string;
...
declare namespace $.$$ {
    class $bog_testops_app_library extends $.$bog_testops_app_library {
        realm(): typeof $hyoo_crus_glob;
        profile(): $bog_testops_profile | null;
        testcases_all(): readonly $bog_testops_testcase[];
        search(next?: string): string;
        type_filter(next?: string): string;
        priority_filter(next?: string): string;
        status_filter(next?: string): string;
        filters_reset(): null;
        testcases_filtered(): $bog_testops_testcase[];
        page_size(): number;
        page(next?: number): number;
        page_count(): number;
        testcase_ids_page(): string[];
        testcase_row(id: string): $bog_testops_app_library_row;
        testcase_rows(): $bog_testops_app_library_row[];
        page_has_prev(): boolean;
        page_has_next(): boolean;
        page_prev(): null;
        page_next(): null;
    ...
    class $bog_testops_app_library_row extends $.$bog_testops_app_library_row {
        ...
        testcase_id(next?: string): string;
        testcase(): $bog_testops_testcase;
        title_text(): string;
        Feature(): string;
        Priority(): string;
        TestType(): string;
...
declare namespace $.$$ {
    class $bog_testops_app_settings extends $.$bog_testops_app_settings {
        realm(): typeof $hyoo_crus_glob;
        settings_obj(): $bog_testops_settings | null;
        api_key(next?: string): string;
        api_model(next?: string): string;
        api_test(): Promise<null>;
        gitlab_token(next?: string): string;
        gitlab_url(next?: string): string;
        gitlab_project(next?: string): string;
        gitlab_test(): Promise<null>;
        allure_owner(next?: string): string;
        save(): null;
        reset(): null;
    }
...
declare namespace $.$$ {
    const $bog_testops_profile_base: Omit<typeof $hyoo_crus_dict, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_dict, {
        readonly TestCases: (auto?: any) => {
            remote_list(next?: readonly $bog_testops_testcase[] | undefined): readonly $bog_testops_testcase[];
            remote_add(item: $bog_testops_testcase): void;
            make(config: null | number | $hyoo_crus_rank_preset | $hyoo_crus_land): $bog_testops_testcase;
            remote_make(config: $hyoo_crus_rank_preset): $bog_testops_testcase;
            local_make(idea?: number): $bog_testops_testcase;
            items(next?: readonly ((symbol & {
                $hyoo_crus_ref: symbol;
            }) | null)[] | undefined): readonly ((symbol & {
                $hyoo_crus_ref: symbol;
        ...
        readonly TestSuites: (auto?: any) => {
            remote_list(next?: readonly $bog_testops_testsuite[] | undefined): readonly $bog_testops_testsuite[];
            remote_add(item: $bog_testops_testsuite): void;
            make(config: null | number | $hyoo_crus_rank_preset | $hyoo_crus_land): $bog_testops_testsuite;
            remote_make(config: $hyoo_crus_rank_preset): $bog_testops_testsuite;
            local_make(idea?: number): $bog_testops_testsuite;
            items(next?: readonly ((symbol & {
                $hyoo_crus_ref: symbol;
            }) | null)[] | undefined): readonly ((symbol & {
                $hyoo_crus_ref: symbol;
     ...
     */
    export class $bog_testops_profile extends $bog_testops_profile_base {
    }
    const $bog_testops_testcase_base: Omit<typeof $hyoo_crus_dict, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_dict, {
        readonly Title: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Description: (auto?: any) => $hyoo_crus_text | null;
        readonly Priority: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Owner: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Feature: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Story: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly TestType: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Suite: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly JiraLink: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly JiraName: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Tags: (auto?: any) => $hyoo_crus_text | null;
        readonly PythonCode: (auto?: any) => $hyoo_crus_text | null;
        readonly AutomatedCode: (auto?: any) => $hyoo_crus_text | null;
        readonly Steps: (auto?: any) => $hyoo_crus_text | null;
        readonly CreatedAt: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly UpdatedAt: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Status: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly AiCoverage: (auto?: any) => $hyoo_crus_text | null;
        readonly AiSuggestions: (auto?: any) => $hyoo_crus_text | null;
        readonly AiValidation: (auto?: any) => $hyoo_crus_text | null;
        readonly Requirements: (auto?: any) => $hyoo_crus_text | null;
        readonly ApiSpec: (auto?: any) => $hyoo_crus_text | null;
    }>) & {
        schema: {
            [x: string]: typeof $hyoo_crus_node;
        } & {
            readonly Title: typeof $hyoo_crus_atom_str;
            readonly Description: typeof $hyoo_crus_text;
            readonly Priority: typeof $hyoo_crus_atom_str;
            readonly Owner: typeof $hyoo_crus_atom_str;
            readonly Feature: typeof $hyoo_crus_atom_str;
            readonly Story: typeof $hyoo_crus_atom_str;
            readonly TestType: typeof $hyoo_crus_atom_str;
            readonly Suite: typeof $hyoo_crus_atom_str;
            readonly JiraLink: typeof $hyoo_crus_atom_str;
            readonly JiraName: typeof $hyoo_crus_atom_str;
            readonly Tags: typeof $hyoo_crus_text;
            readonly PythonCode: typeof $hyoo_crus_text;
            readonly AutomatedCode: typeof $hyoo_crus_text;
            readonly Steps: typeof $hyoo_crus_text;
            readonly CreatedAt: typeof $hyoo_crus_atom_str;
            readonly UpdatedAt: typeof $hyoo_crus_atom_str;
            readonly Status: typeof $hyoo_crus_atom_str;
            readonly AiCoverage: typeof $hyoo_crus_text;
            readonly AiSuggestions: typeof $hyoo_crus_text;
            readonly AiValidation: typeof $hyoo_crus_text;
            readonly Requirements: typeof $hyoo_crus_text;
            readonly ApiSpec: typeof $hyoo_crus_text;
        };
    };
    /**
     * Тест-кейс в формате Allure TestOps as Code
     */
    export class $bog_testops_testcase extends $bog_testops_testcase_base {
    }
    const $bog_testops_testsuite_base: Omit<typeof $hyoo_crus_dict, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_dict, {
        readonly Name: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly Description: (auto?: any) => $hyoo_crus_text | null;
        readonly Product: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly ProductType: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly BaseUrl: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly CreatedAt: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly UpdatedAt: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly AiCoverageReport: (auto?: any) => $hyoo_crus_text | null;
        readonly AiDuplicates: (auto?: any) => $hyoo_crus_text | null;
        readonly AiGaps: (auto?: any) => $hyoo_crus_text | null;
    }>) & {
        schema: {
            [x: string]: typeof $hyoo_crus_node;
        } & {
            ...
            readonly Description: typeof $hyoo_crus_text;
            readonly Product: typeof $hyoo_crus_atom_str;
            readonly ProductType: typeof $hyoo_crus_atom_str;
            readonly BaseUrl: typeof $hyoo_crus_atom_str;
            readonly CreatedAt: typeof $hyoo_crus_atom_str;
            readonly UpdatedAt: typeof $hyoo_crus_atom_str;
            readonly AiCoverageReport: typeof $hyoo_crus_text;
            readonly AiDuplicates: typeof $hyoo_crus_text;
            readonly AiGaps: typeof $hyoo_crus_text;
        };
    };
    /**
     * Тест-сьют - набор связанных тест-кейсов
     */
    export class $bog_testops_testsuite extends $bog_testops_testsuite_base {
    }
    const $bog_testops_settings_base: Omit<typeof $hyoo_crus_dict, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_dict, {
        readonly EvolutionApiKey: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly EvolutionModel: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly GitlabToken: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly GitlabUrl: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly GitlabProjectId: (auto?: any) => $hyoo_crus_atom_str | null;
        readonly AllureOwnerDefault: (auto?: any) => $hyoo_crus_atom_str | null;
    }>) & {
        schema: {
            [x: string]: typeof $hyoo_crus_node;
        } & {
            readonly EvolutionApiKey: typeof $hyoo_crus_atom_str;
            readonly EvolutionModel: typeof $hyoo_crus_atom_str;
            readonly GitlabToken: typeof $hyoo_crus_atom_str;
            readonly GitlabUrl: typeof $hyoo_crus_atom_str;
            readonly GitlabProjectId: typeof $hyoo_crus_atom_str;
            readonly AllureOwnerDefault: typeof $hyoo_crus_atom_str;
        };
    };
    /**
     * Настройки приложения
     */
    export class $bog_testops_settings extends $bog_testops_settings_base {
    }
    export {};
}
